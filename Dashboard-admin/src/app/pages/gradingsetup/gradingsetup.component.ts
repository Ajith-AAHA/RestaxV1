...
@Component({
  selector: 'ngx-gradingsetup',
  templateUrl: './gradingsetup.component.html',
  styleUrls: ['./gradingsetup.component.scss']
})
export class GradingsetupComponent implements OnInit {
...
removecourse() {
this.CoursedataService.deleteCustomer(this.course_id)
.subscribe(
data => {
console.log(data);
this.courses = data;
...
this.CoursedataService.getCustomersList().subscribe((data: any) => {
this.courses = data;
