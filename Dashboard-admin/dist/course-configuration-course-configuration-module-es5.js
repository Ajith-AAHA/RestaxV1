...
/***/ "./node_modules/angular-d3-tree/fesm5/angular-d3-tree.js":
/*!***************************************************************!*\
  !*** ./node_modules/angular-d3-tree/fesm5/angular-d3-tree.js ***!
  \***************************************************************/
...
var TreeModel = /** @class */ (function () {
     ...
     * @return {?}
     */
    TreeModel.prototype.addSvgToContainer = /**
     * @param {?} chartContainer
     * @return {?}
     */
    function (chartContainer) {
        var /** @type {?} */ element = chartContainer.nativeElement;
     ...
     * @return {?}
     */
    TreeModel.prototype.setZoomBehaviour = /**
     * @return {?}
     */
    function () {
        var /** @type {?} */ zoom$$1 = Object(d3__WEBPACK_IMPORTED_MODULE_0__["zoom"])().on("zoom", zoomed);
        var /** @type {?} */ svg = Object(d3__WEBPACK_IMPORTED_MODULE_0__["select"])("svg");
     ...
     * @return {?}
     */
    TreeModel.prototype.createLayout = /**
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    TreeModel.prototype.createTreeData = /**
     * @param {?} treeData
     * @return {?}
     */
    function (treeData) {
        ...
        this.root.y0 = 0;
        this.root.children.map(function (d) { return _this.collapse(d); });
    };
    /**
     * @param {?} d
     * @return {?}
     */
    TreeModel.prototype.collapse = /**
     * @param {?} d
     * @return {?}
     */
    function (d) {
        ...
        if (d.children) {
            ...
            d._children.map(function (d) { return _this.collapse(d); });
            d.children = null;
        }
    };
    /**
    ...
    function (d) {
        ...
        if (d._children) {
            ...
            d.children.map(function (d) { return _this.expand(d); });
            d.children = null;
        }
    };
    /**
     ...
     * @return {?}
     */
    TreeModel.prototype.expandAndFixHeight = /**
     * @param {?} d
     * @param {?} newParent
     * @return {?}
     */
    function (d, newParent) {
        var _this = this;
        ...
        if (d.children) {
            d.children.map(function (child) { return _this.expandAndFixHeight(child, d); });
        }
    };
    /**
     * @param {?} source
     ...
     */
    function (source) {
        var /** @type {?} */ treeData = this.treeLayout(this.root);
     ...
     * @return {?}
     */
    TreeModel.prototype.setNodes = /**
     * @param {?} source
     * @param {?} treeData
     * @return {?}
     */
    function (source, treeData) {
        var /** @type {?} */ nodes = treeData.descendants();
        var /** @type {?} */ treeModel = this;
     ...
     * @return {?}
     */
    TreeModel.prototype.dragBehaviour = /**
     * @return {?}
     */
    function () {
        var /** @type {?} */ treeModel = this;
        ...
        function dragged(d) {
            ...
            if (treeModel.dragStarted) {
                treeModel.svg.selectAll("g.node").sort(function (a, b) {
                ...
                var /** @type {?} */ childs = d.descendants();
                if (childs.length > 1) {
                    // remove link paths
                    var /** @type {?} */ links = d.links();
                    ...
                    // remove child nodes
                    var /** @type {?} */ nodesExit = treeModel.svg.selectAll("g.node")
                ...
                // remove parent link
                var /** @type {?} */ parentLink = d.links(d.parent.descendants());
                treeModel.svg.selectAll('path.link').filter(function (d, i) {
                    if (d.id == treeModel.draggingNode.id) {
                        return true;
                    }
     ...
     * @return {?}
     */
    TreeModel.prototype.overCircle = /**
     * @param {?} d
     * @return {?}
     */
    function (d) {
    ...
    function (source, treeData) {
        var _this = this;
        var /** @type {?} */ links = treeData.descendants().slice(1);
        ...
        var /** @type {?} */ linkEnter = link.enter().insert('path', "g")
            ...
            return _this.diagonalCurvedPath(o, o);
        });
        var /** @type {?} */ linkUpdate = linkEnter.merge(link);
        linkUpdate.transition()
            .duration(this.duration)
            .attr('d', function (d) { return _this.diagonalCurvedPath(d, d.parent); });
     ...
     * @return {?}
     */
    TreeModel.prototype.diagonalCurvedPath = /**
     * @param {?} s
     * @param {?} d
     * @return {?}
     */
    function (s, d) {
        var /** @type {?} */ path = "M " + s.y + " " + s.x + "\n            C " + (s.y + d.y) / 2 + " " + s.x + ",\n              " + (s.y + d.y) / 2 + " " + d.x + ",\n              " + d.y + " " + d.x;
        return path;
    };
    /**
     * @param {?} x
     ...
     * @return {?}
     */
    TreeModel.prototype.radialPoint = /**
     * @param {?} x
     * @param {?} y
     * @return {?}
     */
     ...
     * @return {?}
     */
    TreeModel.prototype.nodechanged = /**
     * @param {?} node
     * @return {?}
     */
    function (node) {
     ...
     * @return {?}
     */
    TreeModel.prototype.nodeselected = /**
     * @param {?} node
     * @return {?}
     */
    function (node) { };
 ...
 * @suppress {checkTypes} checked by tsc
 */
var AngularD3TreeLibService = /** @class */ (function () {
    function AngularD3TreeLibService() {
     ...
     * @return {?}
     */
    AngularD3TreeLibService.prototype.createChart = /**
     * @param {?} chartContainer
     * @param {?} treeData
     * @return {?}
     */
    function (chartContainer, treeData) {
        var /** @type {?} */ element = chartContainer.nativeElement;
        element.innerHTML = "";
     ...
     * @return {?}
     */
    AngularD3TreeLibService.prototype.update = /**
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    AngularD3TreeLibService.prototype.setNodeChangedListener = /**
     * @param {?} callable
     * @return {?}
     */
    function (callable) {
     ...
     * @return {?}
     */
    AngularD3TreeLibService.prototype.setNodeSelectedListener = /**
     * @param {?} callable
     * @return {?}
     */
    function (callable) {
     ...
     * @return {?}
     */
    AngularD3TreeLibService.prototype.addNode = /**
     * @param {?} node
     * @return {?}
     */
    function (node) {
    ...
    /** @nocollapse */
    AngularD3TreeLibService.ctorParameters = function () { return []; };
    ...
    return AngularD3TreeLibService;
}());
 ...
 * @suppress {checkTypes} checked by tsc
 */
var AngularD3TreeLibComponent = /** @class */ (function () {
    function AngularD3TreeLibComponent(treeService) {
        var _this = this;
        ...
        treeService.setNodeChangedListener(function (node) {
            _this.onNodeChanged.emit(node);
        });
        treeService.setNodeSelectedListener(function (node) {
            _this.onNodeSelected.emit(node);
        });
    }
    /**
     * @return {?}
     */
    AngularD3TreeLibComponent.prototype.ngOnInit = /**
     * @return {?}
     */
    function () {
    };
     ...
     * @return {?}
     */
    AngularD3TreeLibComponent.prototype.ngOnChanges = /**
     * @param {?} changes
     * @return {?}
     */
    function (changes) {
     ...
     * @return {?}
     */
    AngularD3TreeLibComponent.prototype.seedTree = /**
     * @return {?}
     */
    function () {
        if (!!this.treeData) {
    ...
    /** @nocollapse */
    AngularD3TreeLibComponent.ctorParameters = function () { return [
    ...
    return AngularD3TreeLibComponent;
}());
 ...
 * @suppress {checkTypes} checked by tsc
 */
var AngularD3TreeLibModule = /** @class */ (function () {
    function AngularD3TreeLibModule() {
    }
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
...
var CourseConfigurationRoutingModule = /** @class */ (function () {
    function CourseConfigurationRoutingModule() {
    }
    ...
    return CourseConfigurationRoutingModule;
}());
...
/* harmony import */ var angular_d3_tree__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! angular-d3-tree */ "./node_modules/angular-d3-tree/fesm5/angular-d3-tree.js");
...
var CourseConfigurationModule = /** @class */ (function () {
    function CourseConfigurationModule() {
    }
    ...
    return CourseConfigurationModule;
}());
...
/* harmony import */ var angular_d3_tree__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! angular-d3-tree */ "./node_modules/angular-d3-tree/fesm5/angular-d3-tree.js");
...
var CourseComponent = /** @class */ (function () {
    function CourseComponent(apollo, treeService) {
        this.apollo = apollo;
        this.treeService = treeService;
        this.user = {};
    ...
    CourseComponent.prototype.nodeUpdated = function (node) {
        console.info('app detected node change');
    };
    CourseComponent.prototype.nodeSelected = function (node) {
        console.info('app detected node selected', node);
        this.selectedNode = node;
    };
    CourseComponent.prototype.addNode = function () {
        var parent = this.selectedNode ? this.selectedNode.id : '1';
        var name = window.prompt('new node name');
        this.treeService.addNode({ id: '999', descripcion: name, parent: parent });
    };
    CourseComponent.prototype.ngOnInit = function () {
        this.getAllcourses();
    };
    CourseComponent.prototype.addFieldValue = function () {
        this.fieldArray.push(this.newAttribute);
        this.newAttribute = {};
    };
    CourseComponent.prototype.deleteFieldValue = function (index) {
    ...
    //   alert('it worked');
    // }
    CourseComponent.prototype.Cancel = function (course) {
        course.editable = !course.editable;
        this.EditRecord = true;
        this.EditActions = false;
    };
     ...
     * @param coursename
     */
    CourseComponent.prototype.addcourse = function (coursename, index) {
        var _this = this;
        this.apollo
            .mutate({
            ...
            update: function (proxy, _a) {
                ...
                var addcourse = _a.data.addcourse;
                var data = proxy.readQuery({ query: _query__WEBPACK_IMPORTED_MODULE_3__["courses"] });
                data.courses.push(addcourse);
                // write our data back to cache
                proxy.writeQuery({ query: _query__WEBPACK_IMPORTED_MODULE_3__["courses"], data: data });
            },
    ...
    CourseComponent.prototype.getAllcourses = function () {
        ...
        this.apollo.watchQuery({ query: _query__WEBPACK_IMPORTED_MODULE_3__["courses"] })
            .valueChanges
            .map(function (result) { return result.data.courses; }).subscribe(function (data) {
            _this.courses = data;
        });
    };
    /**
    ...
    CourseComponent.prototype.removecourse = function (id) {
        this.apollo
            .mutate({
            ...
            // @ts-ignore
            update: function (proxy, _a) {
                var removecourse = _a.data.removecourse;
                // Read the data from our cache for this query.
                var data = proxy.readQuery({ query: _query__WEBPACK_IMPORTED_MODULE_3__["courses"] });
                var index = data.courses.map(function (x) { return x.id; }).indexOf(id);
    ...
    /**
       ...
       */
    // tslint:disable-next-line: no-shadowed-variable
    CourseComponent.prototype.updatecourse = function (course) {
        var _this = this;
        this.apollo
            .mutate({
            ...
            // @ts-ignore
            update: function (proxy, _a) {
                var updatecourse = _a.data.updatecourse;
                // Read the data from our cache for this query.
                var data = proxy.readQuery({ query: _query__WEBPACK_IMPORTED_MODULE_3__["courses"] });
                var index = data.users.map(function (x) { return x.id; }).indexOf(_this.course.id);
    ...
    CourseComponent.prototype.Course = function () {
        this.setcourse = true;
        this.department = false;
        this.level = false;
    ...
    CourseComponent.prototype.Depts = function () {
        this.setcourse = false;
    ...
    CourseComponent.prototype.Levels = function () {
        this.setcourse = false;
        this.department = false;
        this.level = true;
        this.Unknownstate = false;
    ...
    CourseComponent.prototype.BlockTree = function () {
        this.Blocktree = true;
        this.Unknownstate = false;
        this.setcourse = false;
        this.level = false;
...
var addcourse = graphql_tag__WEBPACK_IMPORTED_MODULE_1___default()(templateObject_1 || (templateObject_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\n  mutation addcourse($coursename: String!) {\n    addcourse(\n      coursename: $coursename,\n    ) {\n      id\n      coursename\n    }\n  }\n"], ["\n  mutation addcourse($coursename: String!) {\n    addcourse(\n      coursename: $coursename,\n    ) {\n      id\n      coursename\n    }\n  }\n"])));
var courses = graphql_tag__WEBPACK_IMPORTED_MODULE_1___default()(templateObject_2 || (templateObject_2 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\n  query {\n    courses{\n      id\n      coursename\n    }\n  }"], ["\n  query {\n    courses{\n      id\n      coursename\n    }\n  }"])));
var removecourse = graphql_tag__WEBPACK_IMPORTED_MODULE_1___default()(templateObject_3 || (templateObject_3 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\n  mutation removecourse($id: String!) {\n    removecourse(id: $id) {\n      id\n      coursename\n    }\n  }"], ["\n  mutation removecourse($id: String!) {\n    removecourse(id: $id) {\n      id\n      coursename\n    }\n  }"])));
var updatecourse = graphql_tag__WEBPACK_IMPORTED_MODULE_1___default()(templateObject_4 || (templateObject_4 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\nmutation updatecourse(\n  $id:String!,\n  $coursename:String!\n  ){\n  updatecourse(\n    id:$id,\n    coursename:$coursename\n    ){\n    id\n    coursename\n  }\n}"], ["\nmutation updatecourse(\n  $id:String!,\n  $coursename:String!\n  ){\n  updatecourse(\n    id:$id,\n    coursename:$coursename\n    ){\n    id\n    coursename\n  }\n}"])));
...
//# sourceMappingURL=course-configuration-course-configuration-module-es5.js.map